...
# reorder the columns of data to get them easier to recognise
dump_data = join_data[["purchase_date", "purchase_month",
                       "item_name", "item_price", "顧客名", "かな", "地域", "メールアドレス", "登録日"]]
# print(dump_data)
dump_data.to_csv("dump_data.csv", index=False)  # output as csv file
