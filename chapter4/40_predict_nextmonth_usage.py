...
# predict next month's usage for 2 customers
customer_1 = [3, 4, 4, 6, 8, 7, 8] # arrived 3, 4, 4, 6, 8, 7 times from 6 months ago to now, have been membership for 8 months
customer_2 = [2, 2, 3, 3, 4, 6, 8] # arrived 2, 2, 3, 3, 4, 6 times from 6 months ago to now, have been membership for 8 months
customer_pred = [customer_1, customer_2]
# model.predict(customer_pred)
print(model.predict(customer_pred))
